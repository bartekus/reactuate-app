...
GRANT USAGE ON SCHEMA app_hidden TO alltrades_visitor;
...
GRANT USAGE ON SCHEMA app_public TO alltrades_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.users TO alltrades_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.users TO alltrades_visitor;
...
GRANT UPDATE(avatar_url) ON TABLE app_public.users TO alltrades_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_authentications TO alltrades_visitor;
...
GRANT SELECT,USAGE ON SEQUENCE app_public.user_authentications_id_seq TO alltrades_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_emails TO alltrades_visitor;
...
GRANT INSERT(email) ON TABLE app_public.user_emails TO alltrades_visitor;
...
GRANT SELECT,USAGE ON SEQUENCE app_public.user_emails_id_seq TO alltrades_visitor;
...
GRANT SELECT,USAGE ON SEQUENCE app_public.users_id_seq TO alltrades_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE alltrades IN SCHEMA app_hidden REVOKE ALL ON SEQUENCES  FROM alltrades;
ALTER DEFAULT PRIVILEGES FOR ROLE alltrades IN SCHEMA app_hidden GRANT SELECT,USAGE ON SEQUENCES  TO alltrades_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE alltrades IN SCHEMA app_public REVOKE ALL ON SEQUENCES  FROM alltrades;
ALTER DEFAULT PRIVILEGES FOR ROLE alltrades IN SCHEMA app_public GRANT SELECT,USAGE ON SEQUENCES  TO alltrades_visitor;
